...
from ..text.formatters import text, parse_word
...
keymap.update(
    {
        ...
        "select next [<dgndictation>]": idea_words("find next {}"),
        "search everywhere [for] [<dgndictation>]": [
            idea("action SearchEverywhere"),
            text,
        ],
        "go find [<dgndictation>]": [idea("action Find"), text],
        ...
        "refile": idea("action RenameFile"),
        "toggle debug": idea("action PhpListenDebugAction"),
        "undo": idea("action undo"),
        "redo": idea("action redo"),
    }
)
